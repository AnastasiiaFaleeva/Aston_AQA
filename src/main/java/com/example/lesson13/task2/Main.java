            ...
            try {
                ...
                switch (choice) {
                    case 1 -> {
                        ...
                        System.out.print("Сколько номеров телефонов вы хотите добавить к контакту? ");
                        ...
                        for (int i = 0; i < numberOfPhones; i++) {
                            ...
                            if (phoneBook.containsPhoneNumber(phoneNumber)) {
                                System.out.println("Номер телефона " + phoneNumber + " уже записан в справочник.");
                            } else {
                    ...
                    case 2 -> {
                        ...
                        if (phones.isEmpty()) {
                            System.out.println("Номера телефонов для фамилии " + surnameToSearch + " не найдены.");
                        } else {
                            System.out.println("Номера телефонов для фамилии " + surnameToSearch + ": " + phones);
                        }
                        System.out.println();
                    }
                    case 0 -> {
